...
**Peak activity occurs at `r max_interval`** 
...
**Number of rows with missing values: `r NA_rows`**

**Mean steps per day: `r mean_steps_2`**

**Median steps per day: `r median_steps_2`**
